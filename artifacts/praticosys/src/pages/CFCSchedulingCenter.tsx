...
const CFCSchedulingCenter: React.FC<CFCSchedulingCenterProps> = ({ user }) => {
  ...
  const systemSettingsRef = React.useRef(systemSettings);
  ...
  useEffect(() => {
    if (autoGenerateDate) {
      ...
      const currentSettings = systemSettingsRef.current;
      ...
      const pcdActive = currentSettings?.pcdMainSchedule?.active;
      const pcdDays = currentSettings?.pcdMainSchedule?.days || [];
      ...
      const cnhActive = currentSettings?.cnhBrasilMainSchedule?.active;
      const cnhDays = currentSettings?.cnhBrasilMainSchedule?.days || [];
