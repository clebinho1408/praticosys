        ...
        <header className="h-16 bg-white border-b border-gray-200 flex justify-between items-center px-6 print:hidden shadow-sm z-10">
            ...
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-3">
                    ...
                    <div className="h-9 w-9 bg-slate-100 text-slate-700 rounded-full flex items-center justify-center font-bold shadow-inner border border-gray-200">
                        {user.name.charAt(0)}
                    </div>
                </div>
                ...
                <button 
                    ...
                    className="flex items-center gap-2 text-gray-500 hover:text-red-600 hover:bg-red-50 px-3 py-1.5 rounded-full transition-all text-sm font-medium"
